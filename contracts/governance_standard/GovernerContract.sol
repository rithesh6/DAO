// Has all voting logic that GOvernance token is going to use
// Used openzeppelin wizard to make this contract boilerplate
...
contract GovernerContract is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock,uint256 _votingDelay,uint256 _votingPeriod,uint256 _quorumPercentage)
        ...
        GovernorSettings(_votingDelay /* 1 block */, _votingPeriod /* 45818 = 1 week */, _quorumPercentage)
